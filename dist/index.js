...
var o=require('@stdlib/assert-is-collection/dist'),v=require('@stdlib/assert-is-number/dist').isPrimitive,m=require('@stdlib/array-dtypes/dist'),l=require('@stdlib/array-dtype/dist'),d=require('@stdlib/array-base-assert-contains/dist'),g=require('@stdlib/array-base-join/dist'),c=require('@stdlib/stats-strided-nanstdevyc/dist').ndarray,t=require('@stdlib/error-tools-fmtprodmsg/dist'),i=m("real_and_generic"),y="generic";function p(e){var r,a;if(!o(e))throw new TypeError(t('2S72O',e));if(a=l(e)||y,!d(i,a))throw new TypeError(t('2S7HZ',g(i,'", "'),a));if(arguments.length>1){if(r=arguments[1],!v(r))throw new TypeError(t('2S74A',r))}else r=1;return c(e.length,r,e,1,0)}n.exports=p
